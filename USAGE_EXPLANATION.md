Here is the entire, fully corrected USAGE_EXPLANATION.md file with the broken text boxes completely replaced by a native GitHub Mermaid chart and a clean, perfectly aligned Markdown table.
